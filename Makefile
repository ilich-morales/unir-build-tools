JENKINS_DOCKER_AGENT_SECRET := 9987744bd8a66f729b9e222467e1ba9eb0d71972bf42840a893f674133730f8f
JENKINS_MAVEN_AGENT_SECRET := 51f162ed9241fb310cc0e7f6a8e7fd1accbcb2a53b7056444ffd1ed603d18600
JENKINS_NODE_AGENT_SECRET := a7fa8fd69c52e2a0a56780a51500fce048550b6e5ca24535fe352b66708d2cb6
...
start-jenkins:
	...
	docker run -d --rm --stop-timeout 60 --network jenkins --name jenkins-server --env DOCKER_HOST=tcp://docker:2376 --env DOCKER_CERT_PATH=/certs/client --env DOCKER_TLS_VERIFY=1 --volume jenkins-data:/var/jenkins_home --volume jenkins-docker-certs:/certs/client:ro -p 8080:8080 -p 50000:50000 jenkins/jenkins:2.479.2-lts-alpine
	sleep 30
